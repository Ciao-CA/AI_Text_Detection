...
def eval():
    ...
    # test_df = pd.read_csv('AI_Text_Detection/data/MAGA/test.csv')
    test_df = pd.read_excel('AI_Text_Detection/data/UCAS_AISAD_TEXT-val.xlsx') # 老师提供的csv文件内容有逗号
...
if __name__ == "__main__":
    ...
    # model_name = 'AI_Text_Detection/winner_model/robert-large_text_classifier0'
